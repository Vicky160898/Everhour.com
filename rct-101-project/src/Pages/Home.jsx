        ...
        <Grid templateColumns="repeat(2,25vw 55vw)" gap={20} w="82vw" m="auto">
          <GridItem colSpan={1}>
            <Accordion>
                ...
                <h2>
                  <AccordionButton>
                    ...
                    <Box flex="1" textAlign="left">
                      <Text ml="1vw" fontWeight="semibold" fontSize={22}>
                        Time tracking
                      </Text>
                    </Box>
                  </AccordionButton>
              ...
              <Box textAlign="left">
                <Link>All Everhour features </Link>
              </Box>
            </Accordion>
          </GridItem>
      ...
      <Center  w="80vw" m="auto" mt="15vh">
        ...
        <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Asana</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Trello</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Basecamp</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Jira</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <MarkGithubIcon size={30} />
          <Text fontSize="1.5rem" fontWeight="semibold">Github</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Clickup</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Monday</Text>
          </Flex>
          <Flex direction="row" gap="0.3vw">
          <Image
            ...
            alt="notion"
          />
          <Text fontSize="1.5rem" fontWeight="semibold">Notion</Text>
          </Flex>
        </Flex>
      </Center>
      <Bottom/>
